...
namespace DungeonSim
{
    ...
    public partial class GameWindow : Form
    {
        ...
        private void btnSelectCharacter_Click(object? sender, EventArgs e)
        {
            ...
            AppendToOutput("Enter a number below to view that character's full sheet." + Environment.NewLine + Environment.NewLine);
            detailListMode = DetailListMode.Characters;
        }
        ...
        private void btnShowMap_Click(object? sender, EventArgs e)
        {
            ...
            AppendToOutput(Environment.NewLine);
            AppendToOutput($"Total Explored: {hexMap.GetTotalExploredHexes()}. Enter a number below to view that hex's details." + Environment.NewLine + Environment.NewLine);
        ...
        private void TxtDetailInput_KeyDown(object? sender, KeyEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtDetailInput.Text)) return;

            if (!int.TryParse(txtDetailInput.Text.Trim(), out int num) || num < 1)
            {
        ...
        private void InitializeComponent()
        {
            ...
            void AddMenuButton(Button btn, string text)
            {
                btn.Text = text;
                btn.Width = 140;
                btn.Height = 32;
            ...
            AddMenuButton(btnCreateCharacter, "Create Character");
            AddMenuButton(btnShowCharacterSheet, "Show All Characters");
            AddMenuButton(btnSelectCharacter, "Select Character");
            AddMenuButton(btnShowCreationLog, "Show Creation Log");
            AddMenuButton(btnExploreHex, "Explore Hex");
            AddMenuButton(btnShowMap, "Show Map");
            AddMenuButton(btnClearOutput, "Clear Output");

            panelLeft.Controls.Add(leftFlow);
            ...
            this.txtOutput.ForeColor = Color.Lime;
